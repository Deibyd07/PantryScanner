...
**Puntos:** 8 · **Prioridad:** High · **Sprint:** Sprint 1 · **Etiquetas:** `mvp` `camera` `ml-kit`
...
**Puntos:** 3 · **Prioridad:** High · **Sprint:** Sprint 1 · **Etiquetas:** `mvp` `permisos`
...
**Puntos:** 13 · **Prioridad:** Medium · **Sprint:** Sprint 3 · **Etiquetas:** `api` `integracion`
...
**Puntos:** 5 · **Prioridad:** High · **Sprint:** Sprint 1 · **Etiquetas:** `mvp` `crud`
...
**Puntos:** 2 · **Prioridad:** Low · **Sprint:** Backlog · **Etiquetas:** `enhancement`
...
**Puntos:** 8 · **Prioridad:** High · **Sprint:** Sprint 1 · **Etiquetas:** `mvp` `listado`
...
**Puntos:** 5 · **Prioridad:** Medium · **Sprint:** Sprint 3 · **Etiquetas:** `busqueda` `filtros`
...
**Puntos:** 5 · **Prioridad:** Medium · **Sprint:** Sprint 5 · **Etiquetas:** `filtros`
...
**Puntos:** 5 · **Prioridad:** Low · **Sprint:** Sprint 5 · **Etiquetas:** `sorting`
...
**Puntos:** 3 · **Prioridad:** High · **Sprint:** Sprint 2 · **Etiquetas:** `mvp` `crud`
...
**Puntos:** 3 · **Prioridad:** Medium · **Sprint:** Sprint 5 · **Etiquetas:** `ux`
...
**Puntos:** 8 · **Prioridad:** High · **Sprint:** Sprint 3 · **Etiquetas:** `notificaciones` `config`
...
**Puntos:** 13 · **Prioridad:** High · **Sprint:** Sprint 4 · **Etiquetas:** `notificaciones` `workmanager`
...
**Puntos:** 8 · **Prioridad:** Medium · **Sprint:** Sprint 5 · **Etiquetas:** `notificaciones`
...
**Puntos:** 5 · **Prioridad:** Low · **Sprint:** Backlog · **Etiquetas:** `enhancement`
...
**Puntos:** 5 · **Prioridad:** Low · **Sprint:** Backlog · **Etiquetas:** `ia` `categorias`
...
**Puntos:** 8 · **Prioridad:** Low · **Sprint:** Backlog · **Etiquetas:** `categorias` `crud`
...
**Puntos:** 13 · **Prioridad:** Very Low · **Sprint:** Backlog · **Etiquetas:** `analytics` `charts`
...
**Puntos:** 8 · **Prioridad:** High · **Sprint:** Sprint 2 · **Etiquetas:** `mvp` `offline` `database`
...
**Puntos:** 8 · **Prioridad:** Low · **Sprint:** Backlog · **Etiquetas:** `backup` `export`
...
**Puntos:** 5 · **Prioridad:** Medium · **Sprint:** Sprint 3 · **Etiquetas:** `onboarding` `ux`
...
**Puntos:** 5 · **Prioridad:** Low · **Sprint:** Sprint 6 · **Etiquetas:** `theme` `ui`
...
**Puntos:** 3 · **Prioridad:** Medium · **Sprint:** Sprint 4 · **Etiquetas:** `ux` `empty-states`
