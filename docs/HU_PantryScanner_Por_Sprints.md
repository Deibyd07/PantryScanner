# PantryScanner — Historias de Usuario por Sprint
...
## 🏃 Sprint 1
> **HUs:** 01 · 02 · 04 · 06 · 10 | **Story Points:** 29

---

### HU-01 · Escanear código de barras básico
**Épica:** Escaneo y Registro de Productos | **Prioridad:** High | **Puntos:** 8 | **Etiquetas:** `mvp` `camera` `ml-kit`
...
**Épica:** Escaneo y Registro de Productos | **Prioridad:** High | **Puntos:** 3 | **Etiquetas:** `mvp` `permisos`
...
**Épica:** Escaneo y Registro de Productos | **Prioridad:** High | **Puntos:** 5 | **Etiquetas:** `mvp` `crud`
...
**Épica:** Gestión de Inventario | **Prioridad:** High | **Puntos:** 8 | **Etiquetas:** `mvp` `listado`
...
**Épica:** Gestión de Inventario | **Prioridad:** High | **Puntos:** 5 | **Etiquetas:** `mvp` `crud`
...
## 🏃 Sprint 2
> **HUs:** 11 · 20 | **Story Points:** 11

---

### HU-11 · Eliminar producto
**Épica:** Gestión de Inventario | **Prioridad:** High | **Puntos:** 3 | **Etiquetas:** `mvp` `crud`
...
**Épica:** Persistencia y Sincronización | **Prioridad:** High | **Puntos:** 8 | **Etiquetas:** `mvp` `offline` `database`
...
## 🏃 Sprint 3
> **HUs:** 03 · 07 · 13 · 22 | **Story Points:** 31

---

### HU-03 · Buscar información de producto por código
**Épica:** Escaneo y Registro de Productos | **Prioridad:** Medium | **Puntos:** 13 | **Etiquetas:** `api` `integracion`
...
**Épica:** Gestión de Inventario | **Prioridad:** Medium | **Puntos:** 5 | **Etiquetas:** `busqueda` `filtros`
...
**Épica:** Notificaciones Inteligentes | **Prioridad:** High | **Puntos:** 8 | **Etiquetas:** `notificaciones` `config`
...
**Épica:** Experiencia de Usuario | **Prioridad:** Medium | **Puntos:** 5 | **Etiquetas:** `onboarding` `ux`
...
## 🏃 Sprint 4
> **HUs:** 14 · 24 | **Story Points:** 16

---

### HU-14 · Recibir notificación de vencimiento próximo
**Épica:** Notificaciones Inteligentes | **Prioridad:** High | **Puntos:** 13 | **Etiquetas:** `notificaciones` `workmanager`
...
**Épica:** Experiencia de Usuario | **Prioridad:** Medium | **Puntos:** 3 | **Etiquetas:** `ux` `empty-states`
...
## 🏃 Sprint 5
> **HUs:** 08 · 09 · 12 · 15 | **Story Points:** 21

---

### HU-08 · Filtrar por categoría
**Épica:** Gestión de Inventario | **Prioridad:** Medium | **Puntos:** 5 | **Etiquetas:** `filtros`
...
**Épica:** Gestión de Inventario | **Prioridad:** Low | **Puntos:** 5 | **Etiquetas:** `sorting`
...
**Épica:** Gestión de Inventario | **Prioridad:** Medium | **Puntos:** 3 | **Etiquetas:** `ux`
...
**Épica:** Notificaciones Inteligentes | **Prioridad:** Medium | **Puntos:** 8 | **Etiquetas:** `notificaciones`
...
## 🏃 Sprint 6
> **HUs:** 23 | **Story Points:** 5

---

### HU-23 · Modo oscuro
**Épica:** Experiencia de Usuario | **Prioridad:** Low | **Puntos:** 5 | **Etiquetas:** `theme` `ui`
...
## 📋 Backlog
> **HUs:** 05 · 16 · 17 · 18 · 19 · 21 | **Story Points:** 33

---

### HU-05 · Escaneo con flash en ambientes oscuros
**Épica:** Escaneo y Registro de Productos | **Prioridad:** Low | **Puntos:** 2 | **Etiquetas:** `enhancement`
...
**Épica:** Notificaciones Inteligentes | **Prioridad:** Low | **Puntos:** 5 | **Etiquetas:** `enhancement`
...
**Épica:** Categorización y Organización | **Prioridad:** Low | **Puntos:** 5 | **Etiquetas:** `ia` `categorias`
...
**Épica:** Categorización y Organización | **Prioridad:** Low | **Puntos:** 8 | **Etiquetas:** `categorias` `crud`
...
**Épica:** Categorización y Organización | **Prioridad:** Very Low | **Puntos:** 13 | **Etiquetas:** `analytics` `charts`
...
**Épica:** Persistencia y Sincronización | **Prioridad:** Low | **Puntos:** 8 | **Etiquetas:** `backup` `export`
...
| Sprint | HUs | Story Points |
|--------|-----|-------------|
| Sprint 1 | HU-01, 02, 04, 06, 10 | 29 pts |
| Sprint 2 | HU-11, 20 | 11 pts |
| Sprint 3 | HU-03, 07, 13, 22 | 31 pts |
| Sprint 4 | HU-14, 24 | 16 pts |
| Sprint 5 | HU-08, 09, 12, 15 | 21 pts |
| Sprint 6 | HU-23 | 5 pts |
| Backlog | HU-05, 16, 17, 18, 19, 21 | 33 pts |
